...
class newPost(models.Model):
    ...
    likers = models.ManyToManyField("User", related_name="userlikers", blank = True, null= True)
    haters = models.ManyToManyField("User", related_name="userhaters", blank = True, null= True)
